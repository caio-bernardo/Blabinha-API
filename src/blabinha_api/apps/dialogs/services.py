...
class DialogService:
    ...
    async def interact(self, props: DialogCreate, api_key: str, user: User) -> Dialog:
        """Interage com a blabinha produzindo um diálogo.

            Args:
                props: Dados iniciais para construir o diálogo
                api_key: Chave da API do modelo requisitado
                user: Usuário logado requisitando interação
            Returns:
                Dialog: o diálogo criado a partir da interação.
        """
